...
fun FileSpec.Builder.addClass(name: String, builderActions: TypeSpec.Builder.() -> Unit) =
    addType(TypeSpec.classBuilder(name).apply(builderActions).build())

fun FileSpec.Builder.addFunction(name: String, builderActions: FunSpec.Builder.() -> Unit) =
...
fun FunSpec.Companion.build(name: String, builderActions: FunSpec.Builder.() -> Unit) =
    builder(name).apply(builderActions).build()

fun PropertySpec.Builder.getter(builderActions: FunSpec.Builder.() -> Unit) =
...
fun TypeSpec.Builder.addClass(name: String, builderActions: TypeSpec.Builder.() -> Unit) =
    addType(TypeSpec.classBuilder(name).apply(builderActions).build())

fun TypeSpec.Builder.addConstructor(builderActions: FunSpec.Builder.() -> Unit) =
    addFunction(FunSpec.constructorBuilder().apply(builderActions).build())

fun TypeSpec.Builder.addInitializerBlock(builderActions: CodeBlock.Builder.() -> Unit) =
    addInitializerBlock(CodeBlock.builder().apply(builderActions).build())

fun TypeSpec.Builder.addFunction(name: String, builderActions: FunSpec.Builder.() -> Unit) =
    addFunction(FunSpec.builder(name).apply(builderActions).build())
...
fun TypeSpec.Builder.primaryConstructor(builderActions: FunSpec.Builder.() -> Unit) =
    primaryConstructor(FunSpec.constructorBuilder().apply(builderActions).build())

fun TypeSpec.Companion.buildClass(name: String, builderActions: TypeSpec.Builder.() -> Unit) =
